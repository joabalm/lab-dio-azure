...
# Criando modelo de previsão com Microsoft Azure

## Provisão de  aluguel de bicicletas

É necessário ter ou criar uma conta no Azure, caso não tenha você pode criar uma [conta gratuita](https://azure.microsoft.com/pt-br/free/) seguindo o link. 
